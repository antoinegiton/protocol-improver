# main.py - FastAPI backend server for Protocol Improver
...
async def generate_improved_protocol(analysis_id: str, accepted_indices: List[int]):
    """
    Generate improved protocol with accepted suggestions
    
    Args:
        analysis_id: ID from analysis request
        accepted_indices: Indices of suggestions user accepted
